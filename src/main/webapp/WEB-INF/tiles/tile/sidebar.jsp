	...
	<li id="reservation" class="menu nav-item">
		...
		<div id="collapseReservation" class="collapse" aria-labelledby="collapseReservation" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a class="collapse-item" href="utilities-color.html">재동 본사</a> 
				<a class="collapse-item" href="utilities-border.html">삼환빌딩</a> 
				<a class="collapse-item" href="utilities-animation.html">GS 강남타워</a> 
				<a class="collapse-item" href="utilities-other.html">GS 강서타워</a>
			</div>
		</div>
	</li>
